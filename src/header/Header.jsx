...
function Header() {
  ...
  return (
    <>
      <div className="relative w-full m-auto sm:w-11/12 sm:m-auto bg-slate-900 md:w-10/12 md:m-auto lg:w-10/12 lg:m-auto">
          ...
          <div className="hidden lg:block">
            <ul className="inline-flex space-x-8">
              <li>
                <a
                  href="#"
                  className="text-sm font-semibold  hover:text-orange-400 text-white"
                >
                  Home
                </a>
              </li>
      ...
      <div className={`responsive-navigation ${click ? 'flex' : 'hidden'} lg:hidden flex items-center justify-center`}>
        <ul className="w-full text-center">
          <li
            className="text-white w-full hover:bg-slate-500 pt-2 pb-2"
